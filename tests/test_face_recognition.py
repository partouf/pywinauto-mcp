...
face_recognition = pytest.importorskip(
    "face_recognition", reason="face_recognition requires dlib/cmake"
)
...
pytestmark = pytest.mark.skipif(
    not KNOWN_FACE_IMAGE.exists() or not UNKNOWN_FACE_IMAGE.exists(), reason="Test images not found"
)
...
def face_rec():
    ...
    with patch(
        ...
        with patch(
            "pywinauto_mcp.face_recognition.ENCRYPTION_KEY", b"test-key-1234567890123456789012"
        ):
