...
try:
    from pywinauto_mcp.app import OCR_AVAILABLE, app
...
async def get_registered_tools():
    """Get registered tools as a list."""
    try:
...
def main() -> None:
    ...
    try:
        ...
        tool_list = ", ".join(registered_tools) if registered_tools else "No tools registered"
        logger.info(f"Registered tools: {tool_list}")
